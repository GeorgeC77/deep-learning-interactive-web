...
export default function Ch01LinearRegressionPage() {
  return (
    <BishopSectionPage
      ...
      whyCards={[
        {
          question: "为什么最大似然等价于最小二乘？",
          answer: "假设噪声是高斯分布时，对数似然展开后就是负的平方误差和。所以“最可能的参数”和“误差最小的参数”是同一个。",
        },
        {
          question: "为什么需要正则化？",
          answer: "基函数太多或数据太少时，模型会记住训练数据的噪声。正则化惩罚过大的权重，迫使模型选择更平滑的解。",
        },
      ]}
      counterexamples={[
        "用 10 阶多项式拟合 10 个点，训练误差可以是 0，但测试误差可能爆炸——说明低训练误差不等于好模型。",
        "在 ΦᵀΦ 接近奇异时，不加正则化的最小二乘解会变得极大且极不稳定——说明闭式解也需要条件。",
      ]}
            bishopMapping={{
        chapter: "Ch 4",
        section: "4.1",
