  ...
  return (
    <BishopSectionPage
      ...
      whyCards={[
        ...
        {
          question: "为什么高维空间鞍点比局部极小值更常见？",
          answer: "在 D 维空间中，局部极小值要求所有方向曲率为正，而鞍点只要求部分方向为负。维度越高，鞍点出现的概率远大于真正的极小值。",
        },
      ]}
      counterexamples={[
        "在条件数 100 的曲面上，即使学习率调得很小，梯度下降也要走几百步才能到达极小值——说明学习率调参无法解决病态曲面。",
