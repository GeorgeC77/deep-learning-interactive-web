...
export default function Ch02DecisionTheoryPage() {
  return (
    <BishopSectionPage
      ...
      whyCards={[
        {
          question: "为什么需要代价敏感阈值？",
          answer: "不同错误的代价不同。漏诊癌症可能比误诊严重得多，所以即使疾病概率低于 50%，只要超过某个由代价决定的阈值就应该转诊。",
        },
        {
          question: "为什么 ROC 曲线比准确率更可靠？",
          answer: "准确率依赖固定的阈值，而 ROC 展示所有阈值下的表现。当类别不平衡时，准确率可能误导，AUC 却能反映分类器真正的排序能力。",
        },
      ]}
      counterexamples={[
