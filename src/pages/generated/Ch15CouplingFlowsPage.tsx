...
\end{aligned}`,
      ...
      whyCards={[
        {
          question: "为什么耦合流容易计算 Jacobian？",
          answer: "每次只变换一部分维度，且变换参数由不变部分决定，因此 Jacobian 是三角阵，行列式就是对角线缩放因子的乘积。",
        },
        {
          question: "为什么需要交替划分维度？",
          answer: "如果永远只变换同一半，另一半永远不会被更新。交替划分让所有维度都有机会参与非线性变换。",
        },
      ]}
      counterexamples={[
