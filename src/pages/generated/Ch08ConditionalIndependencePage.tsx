  ...
  return (
    <BishopSectionPage
      ...
      whyCards={[
        {
          question: "为什么需要 d-分离？",
          answer: "高维联合分布的独立性难以直接计算。d-分离把概率问题转化为图上的路径阻断问题，让我们只凭图结构就能判断条件独立。",
        },
        {
          question: "为什么汇聚结构会 explaining away？",
          answer: "观察到共同结果后，两个原本独立的原因会变得相关——因为其中一个原因的存在可以“解释”观测结果，从而降低另一个原因的可能性。",
        },
      ]}
      counterexamples={[
        "在链式结构中给定中间节点，路径被阻断；在汇聚结构中给定共同结果，路径反而开通——说明结构决定条件独立方向。",
        "认为条件化汇聚节点的子孙不会解除阻断，实际上任何子孙的观测都会开通路径——说明 d-分离规则需要考虑所有子孙。",
      ]}
            bishopMapping={{
        chapter: "Ch 11",
        section: "11.2",
