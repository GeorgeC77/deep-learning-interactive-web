  ...
  return (
    ...
    },
    {
      ...
      quiz={[
      {
        ...
        options: ["查询、键、值来自同一序列，每个位置都能关注其他位置并分配注意力权重。", "自注意力 与本节讨论的问题完全无关。", "自注意力 在任何情况下都不需要额外假设即可使用。"],
        correctIndex: 0,
      ...
      {
        question: "在一个具体情境中，你发现“位置编码”的结果与直觉相反，首先应该检查什么？",
      ...
      chapter: "Ch 12",
      pages: "Ch 12",
      textbookSubsections: ["自注意力", "多头注意力", "位置编码", "Encoder/Decoder"],
      algorithms: ["位置编码"],
