  ...
  return (
    <BishopSectionPage
      ...
      whyCards={[
        {
          question: "为什么需要决策理论？",
          answer: "模型输出概率后，还要根据业务代价决定行动。同样的概率，在“误诊代价高”和“漏诊代价高”的场景下会做出不同决策。",
        },
        {
          question: "为什么平方损失的最优解是均值？",
          answer: "平方损失对大误差惩罚更重，会把预测拉向概率分布的中心；数学上求导置零正好得到条件均值。",
        },
      ]}
      counterexamples={[
        "在收入分布高度偏斜时，用均值预测收入会比中位数偏离大多数样本——说明均值并不总是最好的预测。",
        "假设所有错误代价相同，在医疗筛查中漏诊癌症和误诊癌症的代价完全不同——说明 0-1 损失在很多场景不适用。",
      ]}
            bishopMapping={{
        chapter: "Ch 4",
        section: "4.2",
