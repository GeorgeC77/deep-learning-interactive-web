...
export default function Ch13EvidenceLowerBoundPage() {
  return (
    <BishopSectionPage
      ...
      summary={"连续隐变量模型中，证据下界为对数似然提供了可优化的下界；EM 算法可视为交替优化 ELBO 的过程。"}
      concepts={[
    {
      title: "ELBO",
    ...
    },
    {
      ...
      coreIntuition={"连续隐变量模型中，证据下界为对数似然提供了可优化的下界；EM 算法可视为交替优化 ELBO 的过程。"}
      commonMistakes={[
      ...
      {
        question: "在一个具体情境中，你发现“PCA 的 EM”的结果与直觉相反，首先应该检查什么？",
        options: ["是否违反了该方法成立的前提条件或数据假设。", "直觉一定是错的，直接接受计算结果。", "一定是代码实现出错，与理论无关。"],
        correctIndex: 0,
        explanation: "正确。PCA 的 EM 的可靠性取决于前提假设是否满足；违反假设时结果可能反直觉但合理。",
      }
    ]}
      bishopMapping={{
      chapter: "Ch 16",
      section: "16.3",
      pages: "Ch 16",
      textbookSubsections: ["16.3.1 ELBO", "16.3.2 EM 算法", "16.3.3 PCA 的 EM"],
      formulas: ["ELBO公式"],
      algorithms: ["EM 算法"],
