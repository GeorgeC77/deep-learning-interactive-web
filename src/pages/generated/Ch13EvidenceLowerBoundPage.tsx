...
export default function Ch13EvidenceLowerBoundPage() {
  return (
    ...
    },
    {
      ...
      {
        question: "关于“PCA 的 EM”，下列说法是否正确？",
        options: ["对概率 PCA 使用 EM 可处理高维数据并避免直接计算大协方差矩阵的特征分解。", "该概念与当前章节无关。", "该概念只适用于无限数据。"],
        correctIndex: 0,
        explanation: "正确。对概率 PCA 使用 EM 可处理高维数据并避免直接计算大协方差矩阵的特征分解。",
      }
    ]}
      bishopMapping={{
      chapter: "Ch 16",
